...
public class DepenseDetailsList {
 
	@XmlElement(name = "NSDictionary")
	public List<DepenseDetails> liste = new ArrayList<DepenseDetails>();
	...
	public List<DepenseDetails> getDepenseDetails() {
		return liste;
	}
	 
	public void setDepenseDetails(List<DepenseDetails> depensedetails) {
